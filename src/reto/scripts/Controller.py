...
KP_STEP = rospy.get_param("/controller_kP_step")
KP_STEP = rospy.get_param("/controller_kP_step")
KI_STEP = rospy.get_param("/controller_kI_step")
KD_STEP = rospy.get_param("/controller_kD_step")

KP_SINE = rospy.get_param("/controller_kP_sine")
KI_SINE = rospy.get_param("/controller_kI_sine")
KD_SINE = rospy.get_param("/controller_kD_sine")

KP_SQUARE = rospy.get_param("/controller_kP_square")
KI_SQUARE = rospy.get_param("/controller_kI_square")
KD_SQUARE = rospy.get_param("/controller_kD_square")
