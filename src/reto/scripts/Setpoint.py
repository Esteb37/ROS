...
AMPLITUDE = rospy.get_param("/setpoint_amplitude")
MAX_AMPLITUDE = rospy.get_param("/setpoint_max_amplitude")
PERIOD = rospy.get_param("/setpoint_period")
MODE = rospy.get_param("/setpoint_mode")
