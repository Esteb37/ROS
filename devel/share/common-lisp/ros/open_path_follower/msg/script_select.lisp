...
(cl:in-package open_path_follower-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <script_select>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'script_select)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name open_path_follower-msg:<script_select> is deprecated: use open_path_follower-msg:script_select instead.")))

(cl:ensure-generic-function 'script_select-val :lambda-list '(m))
(cl:defmethod script_select-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:script_select-val is deprecated.  Use open_path_follower-msg:script_select instead.")
  (script_select m))

(cl:ensure-generic-function 'type_select-val :lambda-list '(m))
(cl:defmethod type_select-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:type_select-val is deprecated.  Use open_path_follower-msg:type_select instead.")
  (type_select m))

(cl:ensure-generic-function 'turn_velocity-val :lambda-list '(m))
(cl:defmethod turn_velocity-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:turn_velocity-val is deprecated.  Use open_path_follower-msg:turn_velocity instead.")
  (turn_velocity m))

(cl:ensure-generic-function 'move_velocity-val :lambda-list '(m))
(cl:defmethod move_velocity-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:move_velocity-val is deprecated.  Use open_path_follower-msg:move_velocity instead.")
  (move_velocity m))

(cl:ensure-generic-function 'total_time-val :lambda-list '(m))
(cl:defmethod total_time-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:total_time-val is deprecated.  Use open_path_follower-msg:total_time instead.")
  (total_time m))

(cl:ensure-generic-function 'square_length-val :lambda-list '(m))
(cl:defmethod square_length-val ((m <script_select>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_path_follower-msg:square_length-val is deprecated.  Use open_path_follower-msg:square_length instead.")
  (square_length m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<script_select>)))
  ...
  "open_path_follower/script_select")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'script_select)))
  "Returns string type for a message object of type 'script_select"
  "open_path_follower/script_select")
